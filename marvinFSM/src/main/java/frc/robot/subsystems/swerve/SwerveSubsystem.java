...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public void addVisionMeasurement(
        ...
        io.addMeasure(visionRobotPoseMeters, timestampSeconds, visionMeasurementStdDevs);
    }
    ...
    private ChassisSpeeds calculateSpeedsBasedOnJoystickInputs() {
        ...
        double xVelocity = (Field.isBlueAlliance() ? -xMagnitude * maxVelocity : xMagnitude * maxVelocity)
                * teleopVelocityCoefficient;
        double yVelocity = (Field.isBlueAlliance() ? -yMagnitude * maxVelocity : yMagnitude * maxVelocity)
                * teleopVelocityCoefficient;
